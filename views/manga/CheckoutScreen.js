...
export const CheckoutScreen = ({ title, dsc, vol, price, author, publisher, type, release, navigation }) => {
                    ...
                    <View style={styles.hl_sec_container}>
                        ...
                        <View style={styles.hl_card_container}>
                            ...
                            <View style={styles.checkout_detail_container}>
                                <Text style={styles.checkout_detail_text}>Autor: {author}Makoto Yukimura</Text>
                                <Text style={styles.checkout_detail_text}>Editorial: {publisher}Norma</Text>
                                <Text style={styles.checkout_detail_text}>Tipo: {type}Tapa blanda</Text>
                                <Text style={styles.checkout_detail_text}>Edición: {release}</Text>
                            </View>
                        </View>
                    </View>
                </View>
